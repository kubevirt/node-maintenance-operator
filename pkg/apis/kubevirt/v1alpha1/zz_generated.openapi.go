...
func schema_pkg_apis_kubevirt_v1alpha1_NodeMaintenance(ref common.ReferenceCallback) common.OpenAPIDefinition {
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubevirt.io/node-maintenance-operator/pkg/apis/kubevirt/v1alpha1.NodeMaintenanceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubevirt.io/node-maintenance-operator/pkg/apis/kubevirt/v1alpha1.NodeMaintenanceStatus"),
						},
					},
				},
			},
